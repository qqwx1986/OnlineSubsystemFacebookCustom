...
public class OnlineSubsystemFacebookCustom : ModuleRules
{
	public OnlineSubsystemFacebookCustom(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		else if (Target.Platform == UnrealTargetPlatform.Android)
		{
			...
			try
			{
				FacebookNFLDir = System.IO.Path.Combine(PluginDirectory, "Source/ThirdParty/Android/Java");
