...
public class FacebookLogin 
{
    ...
    public FacebookLogin(GameActivity activity, final Logger InLog) 
	{
		...
		FBEventsLogger = AppEventsLogger.newLogger(activity);
    } 
    ...
    {
        if(Params == null) {
            FBLog.debug("[JAVA] Facebook logEvent " + EventName );
        }
        else
        {
            FBLog.debug("[JAVA] Facebook logEvent " + EventName + " "+ Params.toString());
        }
        FBEventsLogger.logEvent(EventName, Params);
    }
