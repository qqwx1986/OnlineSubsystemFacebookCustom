...
// typedef TSharedPtr<class FOnlineEventsFacebookCommon, ESPMode::ThreadSafe> FOnlineEventsFacebookCommonPtr;

/**
 *	OnlineSubsystemFacebookCommon - Implementation of the online subsystem for Facebook services
 */
class ONLINESUBSYSTEMFACEBOOKCUSTOM_API FOnlineSubsystemFacebookCommon 
...
protected:
	...
	FOnlineEventsFacebookCommonPtr FacebookEvents;
};
